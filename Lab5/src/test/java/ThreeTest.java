...
public class ThreeTest extends AbstractTest{
    ...
    public void test3()  throws InterruptedException {
        ...
        search.click(getDriver().findElement(By.xpath("//*[@id=\"js\"]/body/div[1]/header/div[1]/nav[2]/ul/li[2]/a")))
                .click((WebElement) By.xpath("//*[@id=\"user\"]")).sendKeys("Anton_Paly")
                .click((WebElement) By.xpath("///*[@id=\"lj_loginwidget_password\"]")).sendKeys("Anton734218100299")
                ...
                .click((WebElement) By.xpath("//*[@id=\"content\"]/div/div/div[2]/textarea")).sendKeys("Test1")
                .click((WebElement) By.xpath("//*[@id=\\\"editorWrapper\\\"]/div[1]/div[2]/div/div/div[2]/div")).sendKeys("abcd")
